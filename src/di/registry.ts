...
// import { AuthModule } from '@/features/auth/di/AuthModule';
...
export function registerFeatureServices(
	...
	// TODO: Register feature services as they are implemented
	// builder
	...
	// 	})
	// 	.registerSingleton(ServiceIdentifiers.AUTH_SERVICE, (container) => {
	// 		const firestoreClient = container.resolve(ServiceIdentifiers.FIRESTORE_CLIENT);
	// 		return new AuthService(firestoreClient);
	// 	})
